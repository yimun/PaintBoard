...
#ifndef _MD5_CHECK_SUM_H
#define _MD5_CHECK_SUM_H
...
namespace Utils
{
	namespace MD5
	{
		...
		public:
			...
			static BOOL GetMD5(BYTE* pBuf, UINT nLength, LPTSTR lpRet, LPDWORD dwTickCount = NULL);
			static BOOL GetMD5(LPCTSTR lpFilePath, LPTSTR lpRet, LPDWORD dwTickCount = NULL);
		...
		protected:
			...
			//
			static BOOL IsValidAddress(const void* lp, UINT nBytes, BOOL bReadWrite = TRUE); 
